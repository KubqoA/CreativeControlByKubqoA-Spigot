    ...
    */
    private File getConfigFile(String file) {
        ...
        if (file.contains("/")) {
            ...
            if (file.startsWith("/")) {
                configFile = new File(CreativeControl.folder + file.replace("/", File.separator));
            } else {
                configFile = new File(CreativeControl.folder + File.separator + file.replace("/", File.separator));
            }

        } else {
            configFile = new File(CreativeControl.folder, file);
        }
