...
public class DatabaseHelper {
    ...
    public void start() {
        try {
            if (dbtype) { //mysql
                ...
                c = DriverManager.getConnection("jdbc:sqlite:" + Main.folder + "/creativecontrol.db");
            }
        } catch (Exception e) {
    ...
    public void checkTables() {
        if (dbtype) { //mysql
            ...
            if (selectSQL("SHOW TABLES LIKE '" + Main.dbprefix + "inventories'") == 0) { //inventories table
            ...
            if (selectSQL("SHOW TABLES LIKE '" + Main.dbprefix + "vehicles'") == 0) { //vehicles table
            ...
            if (selectSQL("SHOW TABLES LIKE '" + Main.dbprefix + "hangings'") == 0) { //hangings table
            ...
            if (selectSQL("SELECT name FROM sqlite_master WHERE type='table' AND name='" + Main.dbprefix + "blocks'") == 0) { //blocks table
            ...
            if (selectSQL("SELECT name FROM sqlite_master WHERE type='table' AND name='" + Main.dbprefix + "inventories'") == 0) { //inventories table
            ...
            if (selectSQL("SELECT name FROM sqlite_master WHERE type='table' AND name='" + Main.dbprefix + "vehicles'") == 0) { //vehicles table
            ...
            if (selectSQL("SELECT name FROM sqlite_master WHERE type='table' AND name='" + Main.dbprefix + "hangings'") == 0) { //hangings table
